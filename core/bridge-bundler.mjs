...
// banner) against the file on disk so a stale generated bridge fails npm
// test instead of silently shipping old bridge sources in the release.
export function assembleBridgeBody(projectRoot) {

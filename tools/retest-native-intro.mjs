...
const token=getToken(state.projectRoot||path.resolve(import.meta.dirname,'..'));
const socket=new WebSocket(`ws://127.0.0.1:${state.port}/client?token=${encodeURIComponent(token)}`);

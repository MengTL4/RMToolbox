...
await ev(
  "[$game_temp.player_transferring, $game_temp.player_new_map_id, $game_temp.player_new_x, $game_temp.player_new_y].inspect"
);
await sleep(1500);
await ev(
  "[$game_temp.player_transferring, $game_temp.player_new_map_id].inspect"
);
await sleep(3000);
await ev(
  "[$game_temp.player_transferring, $game_map.map_id, $scene.class.to_s].inspect"
);

...
var P = function () {
  return ["path", { d: Array.prototype.join.call(arguments, "") }];
};
...
var ICONS = {
  ...
  gamepad: [
    ...
    P(
      "M17.32 5H6.68a4 4 0 0 0-3.98 3.59C2.6 9.42 2 14.46 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.41-1.41A2 2 0 0 1 9.83 16h4.34a2 2 0 0 1 1.41.59L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.54-.6-6.58-.68-7.26A4 4 0 0 0 17.32 5z"
    )
  ],
  sliders: [
    P("M4 21v-7M4 10V3M12 21v-9M12 8V3M20 21v-5M20 12V3M1 14h6M9 8h6M17 16h6")
  ],
  ...
  refresh: [
    P("M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8"),
    P("M21 3v5h-5")
  ],
  ...
  layers: [
    P(
      "M11.17 2.18a2 2 0 0 1 1.66 0l8.58 3.9a1 1 0 0 1 0 1.83l-8.58 3.91a2 2 0 0 1-1.66 0L2.6 7.91a1 1 0 0 1 0-1.83Z"
    ),
    P(
      "m6.08 9.5-3.48 1.58a1 1 0 0 0 0 1.83l8.57 3.9a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83L17.92 9.5"
    ),
    P(
      "m6.08 14.5-3.48 1.58a1 1 0 0 0 0 1.83l8.57 3.9a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83l-3.49-1.58"
    )
  ],
  toggle: [
  ...
  wand: [
    P(
      "M15 4V2M15 16v-2M8 9h2M20 9h2M17.8 11.8 19 13M17.8 6.2 19 5M3 21l9-9M12.2 6.2 11 5"
    )
  ],
...
RMCH.icon = function (name, size) {
  return function () {
    return h(Component_RmIcon, { name: name, size: size });
  };
};

RMCH.iconNames = Object.keys(ICONS);

const Component_RmIcon = {
  name: "RmIcon",
  props: {
...
export default Component_RmIcon;
</script>

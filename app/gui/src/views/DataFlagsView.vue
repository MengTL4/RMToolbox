...
export default {
    ...
    setup: function (props) {
      var draft = store.useDraft(function () { return props.kind + "." + selectedId.value + ".value"; }, function () { return selected.value ? selected.value.value : null; });
      var lockDraft = store.useDraft(function () { return props.kind + "." + selectedId.value + ".lock"; }, function () {
        return selected.value ? (locked.value ? store.lockedValue(props.kind, selectedId.value) : selected.value.value) : null;
      });

...
export default {
    name: "RmPicker",
    components: { RmIcon: Component_RmIcon, RmVirtual: Component_RmVirtual, RmGameIcon: Component_RmGameIcon },
    props: {
    ...
    setup: function (props) {
      ...
      var icons = RMCH.iconset.useGame(function () { return props.show ? props.gameKey : ""; });
      ...
      return { query: query, owned: owned, filtered: filtered, ownedCount: ownedCount, iconsReady: icons.ready };
    },

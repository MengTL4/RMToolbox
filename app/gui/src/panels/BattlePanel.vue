...
export default {
    ...
    setup: function () {
      var draft = store.useDraft(function () { return "battle." + trainer.battleToken + ".hp"; }, {});
            ...
            return h(NFlex, { size: 6, wrap: false, align: "center" }, {
              default: function () {
                return [
                  h(NInputNumber, {
                    size: "tiny",
                    value: draft.value[row.index] == null ? row.hp : draft.value[row.index],
                    min: 0,
                    showButton: false,
                    style: { width: "74px" },
                  ...
                  h(NButton, {
                    size: "tiny",
                    secondary: true,
                    onClick: function () { setHp(row.index, draft.value[row.index] == null ? row.hp : draft.value[row.index]); }
